...
/*   Updated: 2025/10/02 20:35:16 by anony            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_coordinates	get_pixel(int id, t_screen screen, t_coordinates first_pixel)
{
	t_coordinates	pixel;
	int				u_offset;
	int				v_offset;
...
void	get_pixels_coordinates(t_data *data)
{
	...
	screen = get_screen(data->camera);
	first_pixel = get_first_pixel(screen);
	i = 1;
